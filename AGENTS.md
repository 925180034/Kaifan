...
Use Node.js built-in `node:test`. Add focused tests for decision rules, profile constraints, platform-link fallbacks, and frontend state helpers. Name tests after the module under test, for example `decisionEngine.test.js`.
